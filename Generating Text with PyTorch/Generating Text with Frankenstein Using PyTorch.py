{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<torch._C.Generator at 0x7ff203a48cb0>"
      ]
     },
     "execution_count": 1,
     "metadata": {},
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Create Sequences for the Features and Labels:\n",
    "\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      "You will rejoice to hear that no disaster has accompanied the\n",
      "commencement of an enterprise which attracts the needle and may\n",
      "regulate a thousand celestial observations that require only this\n",
      "voyage to render their seeming eccentricities consistent for ever. I\n",
      "shall satiate my ardent curiosity with the sight of a part often depressed. I am\n",
      "about to proceed on a long and difficult voyage, the emergencies of which\n",
      "will demand all my fortitude: I am required not only to raise the second\n",
